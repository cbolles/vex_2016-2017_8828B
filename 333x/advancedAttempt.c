...
{
	int zeroRightPot = 0; //Values to set the potentiometer value to zero
	int zeroLeftPot = 0;

	int positionOpen = 0; //Pot value that the motors is in the open position
	int positionClose = 0;
	...
	{
		//right pincher
		if(SensorValue[rightPot]-zeroRightPot < positionOpen)
		{
			motor[rightPincer] = pincerSpeed;
		}
		else if(SensorValue[rightPot]-zeroRightPot > positionOpen)
		{
			motor[rightPincer] = -pincerSpeed;
		}
		else
		...
		//left pincher
		if(SensorValue[leftPot]-zeroLeftPot < positionOpen)
		{
			motor[leftPincer] = pincerSpeed;
		}
		else if(SensorValue[leftPot]-zeroLeftPot > positionOpen)
		{
			motor[leftPincer] = -pincerSpeed;
		}
		else
	...
	{
		//right pincer
		if(SensorValue[rightPot]-zeroRightPot < positionClose)
		{
			motor[rightPincer] = pincerSpeed;
		}
		else if(SensorValue[rightPot]-zeroRightPot > positionClose)
		{
			motor[rightPincer] = -pincerSpeed;
		}
		else
		...
		//left pincher
		if(SensorValue[leftPot]-zeroLeftPot < positionClose)
		{
			motor[leftPincer] = pincerSpeed;
		}
		else if(SensorValue[leftPot]-zeroLeftPot > positionClose)
		{
			motor[leftPincer] = -pincerSpeed;
		}
		else
